...
# Update system and install PostgreSQL client dependencies
apt-get update
apt-get install -y python3-pip python3-venv postgresql-client libpq-dev
...
# Install dependencies for PostgreSQL and Flask
...
def home():
    ...
    <html>
    <head>
        <title>Day 22 - RDS PostgreSQL Demo App</title>
        <style>
            ...
            h1 {{ color: #336791; margin-top: 0; }}
            .form-group {{ margin-bottom: 15px; }}
            input[type="text"] {{ width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; box-sizing: border-box; }}
            button {{ background: #336791; color: white; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer; font-size: 16px; }}
            button:hover {{ background: #28527a; }}
    ...
    <body>
        <div class="container">
            <div class="card">
                <h1>🚀 Terraform RDS PostgreSQL Demo</h1>
                <p>
                    Status: 
                ...
                <p>This application is running on EC2 and storing data in an RDS PostgreSQL database.</p>
        ...
        if connection and connection.closed == 0:
            ...
            <body>
                <div class="container">
                    ...
                    <p>The Flask application is successfully connected to the RDS PostgreSQL database.</p>
