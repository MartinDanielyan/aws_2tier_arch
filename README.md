...
└── modules/
    ...
    └── ec2/                         # EC2 Module
        ...
        ├── outputs.tf
        └── templates/
            └── user_data.sh         # EC2 bootstrap script Mysql
            └── user_data_psql.sh    # EC2 bootstrap script Psql
```
...
- **Database**: Allows PgSQL (5432) only from the web server security group

### RDS Module
Deploys a PgSQL RDS instance in private subnets with a DB subnet group.
